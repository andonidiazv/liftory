...
export const alta = {
  ...
  accentBg: "rgba(196,162,78,0.10)",
  accentBgStrong: "rgba(196,162,78,0.18)",
  btnText: "#0A0A0A",
  shadow: "rgba(196,162,78,0.20)",
...
export const baja = {
  ...
  accentBg: "rgba(168,137,62,0.10)",
  accentBgStrong: "rgba(168,137,62,0.18)",
  btnText: "#0A0A0A",
