...
function getScoreColor(score: number): string {
  if (score >= 85) return "#C4A24E"; // gold
  if (score >= 70) return "#C4A24E"; // gold
      ...
      <div className="flex flex-col items-center px-5 pb-10 stagger-fade-in">
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <span style={{ fontFamily: "'Syne', sans-serif", fontSize: 22, color: "#C4A24E", fontWeight: 800, letterSpacing: "-0.03em" }}>
              PRIME SCORE
            </span>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: 24 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 8 }}>
              <span style={{ fontFamily: "'DM Mono', monospace", textTransform: "uppercase", borderRadius: 9999, padding: "2px 10px", fontSize: 9, letterSpacing: "0.12em", fontWeight: 700, color: "#C4A24E", background: "rgba(196,162,78,0.15)", border: "1px solid rgba(196,162,78,0.25)" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 20 }}>
            {stats.prs > 0 && (
              <span style={{ display: "flex", alignItems: "center", gap: 4, borderRadius: 9999, padding: "4px 12px", background: "rgba(196,162,78,0.15)", border: "1px solid rgba(196,162,78,0.3)" }}>
                <Star style={{ width: 12, height: 12, color: "#C4A24E" }} />
                <span style={{ fontFamily: "'DM Mono', monospace", textTransform: "uppercase", fontSize: 9, color: "#C4A24E", fontWeight: 600, letterSpacing: "0.1em" }}>
            ...
            {primeScore >= 85 && (
              <span style={{ display: "flex", alignItems: "center", gap: 4, borderRadius: 9999, padding: "4px 12px", background: "rgba(196,162,78,0.15)", border: "1px solid rgba(196,162,78,0.3)" }}>
                <Trophy style={{ width: 12, height: 12, color: "#C4A24E" }} />
                <span style={{ fontFamily: "'DM Mono', monospace", textTransform: "uppercase", fontSize: 9, color: "#C4A24E", fontWeight: 600, letterSpacing: "0.1em" }}>
                  ÉLITE
                </span>
              </span>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6, marginTop: 20, paddingTop: 16, borderTop: "1px solid rgba(232,232,232,0.06)" }}>
            ...
            <span style={{ fontFamily: "'Syne', sans-serif", fontSize: 10, color: "#C4A24E", fontWeight: 800, letterSpacing: "-0.02em" }}>
              LIFTORY
            </span>
          </div>
        </div>
