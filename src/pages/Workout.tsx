                ...
                {setsForCurrentExercise.map((setIdx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="font-mono text-sm text-foreground" style={{ letterSpacing: "0.05em" }}>{currentExercise.weight}</span>
                      <span className="font-mono text-sm text-foreground" style={{ letterSpacing: "0.05em" }}>{currentExercise.reps}</span>
                      <span className="font-mono text-sm text-muted-foreground" style={{ letterSpacing: "0.05em" }}>{currentExercise.rpe}</span>
                      <button
                      ...
                      >
                        {completed && (
                          <Check className="h-4 w-4 text-success-foreground animate-set-complete" />
                        )}
                      </button>
                    </div>
                  );
